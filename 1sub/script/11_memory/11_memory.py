...
df1 = pd.read_csv('/mnt/D/NS-2/20230227-main/Server/ns2/experiment/02_memory/f3.csv')

output = '/mnt/D/NS-2/20230227-main/Server/ns2/experiment/02_memory/maat_f3_1VIP.pdf'
...
plt.ylabel('Memory (MiB)', fontproperties = font2)
