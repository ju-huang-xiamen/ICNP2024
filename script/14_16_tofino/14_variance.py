...
df1 = pd.read_csv('/mnt/D/NS-2/20230227-main/Server/ns2/experiment/08_flow_completetion_time/var.csv')
output = '/mnt/D/NS-2/20230227-main/Server/ns2/experiment/08_flow_completetion_time/var.pdf'
...
y_levels = ['2.5', '3', '3.5', '4', '4.5', '5']
plt.ylim((2.5, 5))
my_y_ticks = np.arange(2.5, 5.1, 0.5)
...
plt.ylabel('Variance (Normalized)', fontproperties = font2)
